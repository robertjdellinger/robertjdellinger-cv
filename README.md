...
[**Dellinger_CV.pdf**](https://github.com/rob-dellinger/Dellinger_RJ_CV/raw/main//Scripts/Dellinger_RJ_CV.pdf) *(Click to open or download directly.)*  

### **Source Files (RMarkdown & TeX)**  
The CV is generated using `RMarkdown` and the **vitae** package.  

- **Main source file:** [`Dellinger_CV.Rmd`](./Scripts/Dellinger_RJ_CV.Rmd)  
